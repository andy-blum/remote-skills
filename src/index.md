...
<div class="hero-badge">● Live Registry</div>

# Hello world

<p class="hero-sub">A dispatch system for autonomous agent skills. Browse, discover, and deploy capabilities for your AI workforce.</p>
...
<div class="skill-grid">
  <a href="{{ "/skills/acli-jira/" | url }}" class="skill-card" style="text-decoration:none">
    ...
    <div class="skill-card__meta">
      <span class="skill-card__tag">cli</span>
  ...
  <a href="{{ "/skills/playwright/" | url }}" class="skill-card" style="text-decoration:none">
    ...
    <div class="skill-card__meta">
      <span class="skill-card__tag">testing</span>
      <span class="skill-card__tag">v1.0.0</span>
    </div>
  </a>
  <a href="{{ "/skills/review/" | url }}" class="skill-card" style="text-decoration:none">
    ...
    <div class="skill-card__meta">
      <span class="skill-card__tag">code review</span>
      <span class="skill-card__tag">v1.0.0</span>
    </div>
  </a>
